...
namespace AppVeterinarios.Migrations
{
    ...
    [Migration("20200501152711_CorrecaoDadosVeterinarios")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppVeterinarios.Models.Animais", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppVeterinarios.Models.Consultas", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppVeterinarios.Models.Donos", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppVeterinarios.Models.Veterinarios", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AppVeterinarios.Models.Animais", b =>
                {
                    b.HasOne("AppVeterinarios.Models.Donos", "Dono")
            ...
            modelBuilder.Entity("AppVeterinarios.Models.Consultas", b =>
                {
                    b.HasOne("AppVeterinarios.Models.Animais", "Animal")
                        .WithMany("ListaConsultas")
                        .HasForeignKey("AnimalFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppVeterinarios.Models.Veterinarios", "Veterinario")
